...
bash "${SCRIPT_DIR}/patch_plugins.sh"
...
bash "${SCRIPT_DIR}/bundle_runtime_libs.sh" "build/linux/x64/release/bundle"

echo "==> Verifying bundle dependencies"
bash "${SCRIPT_DIR}/check_bundle.sh" "build/linux/x64/release/bundle"
